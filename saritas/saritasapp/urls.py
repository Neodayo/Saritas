...
urlpatterns = [
    ...
    path('wardrobe-packages/<int:pk>/', views.WardrobePackageDetailView.as_view(), name='wardrobe_package_detail'),
    path('wardrobe-packages/<int:pk>/update/', views.WardrobePackageUpdateView.as_view(), name='wardrobe_package_update'),
    path('wardrobe-packages/<int:package_id>/add-item/', views.AddPackageItemView.as_view(), name='add_package_item'),
    path('wardrobe-packages/<int:package_id>/items/<int:pk>/edit/',views.EditPackageItemView.as_view(), name='edit_package_item'),
    path('wardrobe-packages/<int:package_id>/add-item/',views.AddPackageItemView.as_view(),name='add_package_item'),
