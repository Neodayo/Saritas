# Generated by Django 4.0 on 2025-04-20 23:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='customer_profile', to='saritasapp.user')),
            ],
        ),
        migrations.CreateModel(
            name='CustomerOrder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='inventory_items', to='saritasapp.color')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('bridal_gown', 'Bridal Gown'), ('groom_tuxedo', "Groom's Tuxedo"), ('maid_of_honor', 'Maid of Honor'), ('bestman', 'Bestman'), ('bridesmaid', 'Bridesmaid'), ('groomsmen', 'Groomsmen'), ('flowergirl', 'Flowergirl'), ('bearer', 'Bearer'), ('mother_gown', "Mother's Gown"), ('father_attire', "Father's Suit")], max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='PackageItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('description', models.TextField(blank=True, null=True)),
                ('tier', models.CharField(blank=True, choices=[('A', 'Package A'), ('B', 'Package B'), ('C', 'Package C'), ('custom', 'Custom Package')], help_text='Predefined package tier (A, B, C) or custom', max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='handled_rentals', to='saritasapp.user')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='saritasapp.user')),
            ],
        ),
        migrations.CreateModel(
            name='Staff',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='staff_profile', to='saritasapp.user')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reservation_price', models.DecimalField(decimal_places=2, default=500.0, editable=False, help_text='Flat reservation fee of ₱500.00 per item', max_digits=8, validators=[django.core.validators.MinValueValidator(500.0), django.core.validators.MaxValueValidator(500.0)])),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('notes', models.TextField(blank=True, null=True)),
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approved_reservations', to='saritasapp.user')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='saritasapp.customer')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='saritasapp.inventory')),
            ],
        ),
        migrations.CreateModel(
            name='Rental',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rental_start', models.DateField(db_index=True, default=django.utils.timezone.now)),
                ('rental_end', models.DateField(db_index=True)),
                ('deposit', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('status', models.CharField(choices=[('Renting', 'Renting'), ('Pending', 'Pending'), ('Approved', 'Approved'), ('Rented', 'Rented'), ('Returned', 'Returned'), ('Overdue', 'Overdue'), ('Cancelled', 'Cancelled'), ('Rejected', 'Rejected')], db_index=True, default='Pending', max_length=10)),
                ...
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approved_rentals', to='saritasapp.user')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rentals', to='saritasapp.customer')),
                ('inventory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rentals', to='saritasapp.inventory')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='managed_rentals', to='saritasapp.user')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('inventory_item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='package_rentals', to='saritasapp.inventory')),
        ...
        migrations.AddField(
            model_name='inventory',
            name='size',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='inventory_items', to='saritasapp.size'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='customerorder',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='handled_orders', to='saritasapp.user'),
        ),
        migrations.AddField(
            model_name='customerorder',
