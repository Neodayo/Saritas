# Generated by Django 4.0 on 2025-04-19 06:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('bridal_gown', 'Bridal Gown'), ('groom_tuxedo', "Groom's Tuxedo"), ('maid_honor', 'Maid of Honor Dress'), ('bestman', 'Bestman Attire'), ('bridesmaid', 'Bridesmaid Dress'), ('groomsmen', 'Groomsmen Attire'), ('flowergirl', 'Flowergirl Dress'), ('bearer', 'Bearer Attire'), ('mother_gown', "Mother's Gown"), ('father_attire', "Father's Attire"), ('accessory', 'Wedding Accessory'), ('other', 'Other')], max_length=50, unique=True, verbose_name='Item Type')),
            ],
            options={
