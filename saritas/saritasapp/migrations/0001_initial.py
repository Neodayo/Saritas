# Generated by Django 4.0 on 2025-03-16 03:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customer', to='saritasapp.user')),
            ],
        ),
        migrations.CreateModel(
            name='CustomerOrder',
        ...
        migrations.AddField(
            model_name='user',
            name='branch',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='saritasapp.branch'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
