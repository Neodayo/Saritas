# Generated by Django 4.0 on 2025-04-11 20:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.CharField(choices=[('internal', "Provided by Sarita's"), ('external', 'Outsourced Service')], default='internal', max_length=10)),
        ...
        migrations.CreateModel(
            name='SelectedWardrobeItem',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('selected_quantity', models.PositiveIntegerField(default=0)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='selected_wardrobe_items', to='saritasapp.customerorder')),
                ('wardrobe_package_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='saritasapp.wardrobepackageitem')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deposit', models.DecimalField(decimal_places=2, help_text='Deposit charged at the time of rental', max_digits=10, verbose_name='Deposit Amount')),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Approved', 'Approved'), ('Rented', 'Rented'), ('Returned', 'Returned'), ('Overdue', 'Overdue'), ('Cancelled', 'Cancelled'), ('Rejected', 'Rejected')], db_index=True, default='Pending', max_length=10)),
